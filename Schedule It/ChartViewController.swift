...
class ChartViewController: UIViewController {
    ...
    func calculate(events: [Task]) {
        ...
        for event in events {
            i = 0
            if (formatter.string(from: event.date!).contains("1:") && formatter.string(from: event.date!).contains("AM")) {
                i = 1
            } else if (formatter.string(from: event.date!).contains("2:") && formatter.string(from: event.date!).contains("AM")) {
                i = 2
            } else if (formatter.string(from: event.date!).contains("3:") && formatter.string(from: event.date!).contains("AM")) {
                i = 3
            } else if (formatter.string(from: event.date!).contains("4:") && formatter.string(from: event.date!).contains("AM")) {
                i = 4
            } else if (formatter.string(from: event.date!).contains("5:") && formatter.string(from: event.date!).contains("AM")) {
                i = 5
            } else if (formatter.string(from: event.date!).contains("6:") && formatter.string(from: event.date!).contains("AM")) {
                i = 6
            } else if (formatter.string(from: event.date!).contains("7:") && formatter.string(from: event.date!).contains("AM")) {
                i = 7
            } else if (formatter.string(from: event.date!).contains("8:") && formatter.string(from: event.date!).contains("AM")) {
                i = 8
            } else if (formatter.string(from: event.date!).contains("9:") && formatter.string(from: event.date!).contains("AM")) {
                i = 9
            } else if (formatter.string(from: event.date!).contains("10:") && formatter.string(from: event.date!).contains("AM")) {
                i = 10
            } else if (formatter.string(from: event.date!).contains("11:") && formatter.string(from: event.date!).contains("AM")) {
                i = 11
            } else if (formatter.string(from: event.date!).contains("12:") && formatter.string(from: event.date!).contains("PM")) {
                i = 12
            } else if (formatter.string(from: event.date!).contains("1:") && formatter.string(from: event.date!).contains("PM")) {
                i = 13
            } else if (formatter.string(from: event.date!).contains("2:") && formatter.string(from: event.date!).contains("PM")) {
                i = 14
            } else if (formatter.string(from: event.date!).contains("3:") && formatter.string(from: event.date!).contains("PM")) {
                i = 15
            } else if (formatter.string(from: event.date!).contains("4:") && formatter.string(from: event.date!).contains("PM")) {
                i = 16
            } else if (formatter.string(from: event.date!).contains("5:") && formatter.string(from: event.date!).contains("PM")) {
                i = 17
            } else if (formatter.string(from: event.date!).contains("6:") && formatter.string(from: event.date!).contains("PM")) {
                i = 18
            } else if (formatter.string(from: event.date!).contains("7:") && formatter.string(from: event.date!).contains("PM")) {
                i = 19
            } else if (formatter.string(from: event.date!).contains("8:") && formatter.string(from: event.date!).contains("PM")) {
                i = 20
            } else if (formatter.string(from: event.date!).contains("9:") && formatter.string(from: event.date!).contains("PM")) {
                i = 21
            } else if (formatter.string(from: event.date!).contains("10:") && formatter.string(from: event.date!).contains("PM")) {
                i = 22
            } else if (formatter.string(from: event.date!).contains("11:") && formatter.string(from: event.date!).contains("PM")) {
                i = 23
            }
            counts[i] += 1
        }
